      ...
      <el-col :xs="24" :sm="24" :lg="24" class="card-panel-col">
       ...
       账号: {{ account.accountNo }}  
         <!-- <el-button style="float: right; padding: 3px 0" type="text">操作按钮</el-button> -->
          ...
          <el-form-item label="账户余额:">{{ account.balance }}/账号
             <el-button class='submitbtn' style="margin-left: 10px;" type="success" @click="recharge()">
               充值
              </el-button>
          </el-form-item>
          <el-form-item label="连接数:">{{ account.currentConnection }}/账号
          </el-form-item>

          <el-form-item label="在线设备数:">{{ account.devices }}/设备
          </el-form-item>

          <el-form-item label="最新5分钟使用的IP:">/统计
               <div class="tancan" v-for="item in account.ipAddress" :key="item.id">
...
export default {
  ...
  methods: {
   ...
   recharge(){
     this.$router.push({ path: "/shop/dingyue", query: {id:1}})
     console.log("开始充值")
   },
