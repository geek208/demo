<template>
  <div class="app-container">
    ...
    <el-table-column width="50px" align="center" label="活动ID">
        <template slot-scope="scope">
          <span>{{ scope.row.id }}</span>
        </template>
     </el-table-column>

      <el-table-column width="50px" align="center" label="活动名称">
        <template slot-scope="scope">
       ...
       <el-table-column width="50px" align="center" label="审批类型">
        <template slot-scope="scope">
          <span>{{ scope.row.approveType }}</span>
        </template>
     </el-table-column>
    ...
    <el-table-column width="100px" align="center" label="用户类型">
      ...
      <el-table-column width="100px" align="center" label="流程名称">
        ...
        <el-table-column width="50px" align="center" label="前序节点">
        <template slot-scope="scope">
          <span>{{ scope.row.preActivity }}</span>
        </template>
      </el-table-column>
...
<script>
import { listActivity, deleteMessage,addMessage } from '@/api/activity'
